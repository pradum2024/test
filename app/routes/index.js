...
export const RoutedContent = () => {
    return (
        <Switch>
            ...
            <Route path="/layouts/Payments" component={Payments} />
            <Route path="/layouts/User" component={User} />
            <Route path="/layouts/Teams" component={Teams} />
            ...
            <Route component={ForgotPassword} path="/pages/forgotPassword" />
            <Route component={LockScreen} path="/pages/lock-screen" />
            <Route component={Login} path="/pages/login" />
            <Route component={Register} path="/pages/register" />
            <Route component={Success} path="/pages/success" />
            <Route component={Timeline} path="/pages/timeline" />
            <Route component={Welcome} path="/pages/welcome" />
...
export const RoutedNavbars = () => (
    <Switch>
        ...
        />
        <Route  
            component={Payments.Navbar}
            path="/layouts/Payments"
        />
         <Route
